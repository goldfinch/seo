...
class OpenGraph extends DataObject
{
    ...
    private static $owns = ['OG_Images', 'OG_Videos', 'OG_Audios'];
        ...
        $fields->addFieldsToTab('Root.Main', [
            CompositeField::create(
                ...
                CheckboxField::create(
                    ...
                    'Any page that is using this OG record will not be displaying any og-related tags',
                ),
            )->addExtraClass('mb-5'),
            ...
            CompositeField::create(
                LiteralField::create(
                    'LF',
                    '<h2 style="font-size: 1.5rem">Basic metadata</h2><p class="mb-4">The four required properties for every page are:</p>',
                ),

                TextField::create('OG_Title', 'Title')->setDescription(
                    'The title of your object as it should appear within the graph, e.g., "The Rock".<br>---<br>The title of your article without any branding such as your site name.',
                ),
            ...
            Wrapper::create(
                CompositeField::create(
                    LiteralField::create(
                        'LF',
                        '<h2 style="font-size: 1.5rem">Article metadata</h2><p class="mb-4">Structured properties</p>',
                    ),
                    ...
                    TextField::create(
                        ...
                        '[datetime] - When the article was first published.<br>eg: <em>1972-06-18 / 1972-06-18T01:23:45Z / 1972-06-17T20:23:45-05:00</em>',
                    ),
                    TextField::create(
                        'OG_Article_ModifiedTime',
                        'Modified time',
                    )->setDescription(
                        '[datetime] - When the article was last changed.<br>eg: <em>1972-06-18 / 1972-06-18T01:23:45Z / 1972-06-17T20:23:45-05:00</em>',
                    ),
                    TextField::create(
                        'OG_Article_ExpirationTime',
                        'Expiration time',
                    )->setDescription(
                        '[datetime] - When the article is out of date after.<br>eg: <em>1972-06-18 / 1972-06-18T01:23:45Z / 1972-06-17T20:23:45-05:00</em>',
                    ),
                    TextField::create(
                        'OG_Article_Section',
                        'Section',
            ...
            Wrapper::create(
                CompositeField::create(
                    LiteralField::create(
                        'LF',
                        '<h2 style="font-size: 1.5rem">Profile metadata</h2><p class="mb-4">Structured properties</p>',
                    ),
                    ...
                    TextField::create(
                        'OG_Profile_Gender',
                        'Gender',
                    )->setDescription('enum(male, female) - Their gender.'),
                )->addExtraClass('mb-5'),
            )
                ->displayIf('OG_Type')
                ->contains('profile')
            ...
            CompositeField::create(
                LiteralField::create(
                    'LF',
                    '<h2 style="font-size: 1.5rem">Optional metadata</h2><p class="mb-4">The following properties are optional for any object and are generally recommended:</p>',
                ),

                TextField::create('OG_SiteName', 'Site name')->setDescription(
                ...
                TextareaField::create(
                    ...
                    'A one to two sentence description of your object.<br>---<br>A brief description of the content, usually between 2 and 4 sentences. This will displayed below the title of the post on Facebook.',
                ),
                TextField::create(
                    'OG_Determiner',
                    'Determiner',
                ...
                SortableUploadField::create('OG_Videos', 'Videos')
                    ->setDescription(
                        'A URL to a video file that complements this object.',
                    )
                    ->setFolderName('seo'),
                SortableUploadField::create('OG_Audios', 'Audios')
                    ->setDescription(
            ...
            CompositeField::create(
                LiteralField::create(
                    'LF',
                    '<h2 style="font-size: 1.5rem">Facebook specific metadata</h2><p class="mb-4">The following properties are related to Facebook only:</p>',
                ),
