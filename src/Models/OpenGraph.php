    ...
    public function getCMSFields()
    {
        ...
        $fields->addFieldsToTab('Root.Main', [
          ...
          CompositeField::create(
            ...
            SortableUploadField::create('OG_Videos', 'Videos')->setDescription('A URL to a video file that complements this object.')->setFolderName('seo'),
            SortableUploadField::create('OG_Audios', 'Audios')->setDescription('A URL to an audio file to accompany this object.')->setFolderName('seo'),
